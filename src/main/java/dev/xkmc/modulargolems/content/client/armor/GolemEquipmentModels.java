...
public class GolemEquipmentModels {
	...
	public static MeshDefinition buildGolemBaseLayers() {
		...
		root1.addOrReplaceChild("right_forearm", CubeListBuilder.create().texOffs(60, 35).addBox(-12.99F, 0F, -6.0F, 4.0F, 16.0F, 6.0F), PartPose.offsetAndRotation(0.0F, 11.5F, 3.0F, 0.0F, 0.0F, 0.0F));
	...
	public static LayerDefinition createChestplateLayer() {
		...
		root.addOrReplaceChild("main_body", CubeListBuilder.create().texOffs(0, 0).addBox(-9.5F, 4.5F, -6.6F, 19.0F, 13.0F, 12.0F, new CubeDeformation(0.0F))
				.texOffs(19, 110).addBox(5.5F, 3.5F, -7.75F, 2.0F, 8.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(105, 28).addBox(-7.5F, 3.5F, -7.75F, 2.0F, 8.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -7.0F, 0.0F));
